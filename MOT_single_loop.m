%=========================================================
% Name: MOT_single_loop.m
% What: compute B field for MOT single loop
% Author: Yu-Hao Yeh (yuhyeh@iu.edu)
% Date: 2022/05/12
% Note: The unit of input / output [T,T,T] = MOT_single_loop(m,m,m,m,A)
%=========================================================

function [Bx,By,Bz] = MOT_single_loop(x,x_p,z_p,R,I0)
%function [Bx] = MOT_single_loop(x,x_p,z_p,R,I0)
